      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/3 space-y-6">
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Let's Connect</h3>
              
              {/* Email */}
              <a
                href={`mailto:${personalInfo.email}`}
                className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-blue-50 transition-colors group mb-4"
              >
              ...
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors group mb-4"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-sky-100 transition-colors group mb-4"
              >
              ...
              {/* Phone */}
              <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 group mb-4">
              ...
              {/* Location */}
              <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 group">
