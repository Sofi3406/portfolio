    ...
    <section id="experience" className="relative py-20 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 mt-4">My journey in the tech world</p>
        </div>
          ...
          {experiences.map((exp, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
